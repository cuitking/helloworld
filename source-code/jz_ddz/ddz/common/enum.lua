...
ETableState = {
	...
	TABLE_STATE_WAIT_PLAYER_CHUPAI = 8,     --等待出牌
	TABLE_STATE_WAIT_ONE_GAME_REAL_END = 9, --等待一局游戏真正结束
	TABLE_STATE_WAIT_GAME_END = 10,     --等待游戏结束
	TABLE_STATE_ONE_GAME_END = 11,      --一局游戏结束
	TABLE_STATE_ONE_GAME_REAL_END = 12, --一局游戏真正结束
	TABLE_STATE_CONTINUE = 13,
	TABLE_STATE_CONTINUE_AND_STANDUP = 14,
	TABLE_STATE_CONTINUE_AND_LEAVE = 15,
	TABLE_STATE_GAME_END = 16,  	    --游戏结束
	TABLE_STATE_WAIT_COUNT_DOWN = 17,   --开始倒计时
	TABLE_STATE_WAIT_CLIENT_ACTION = 18, --等待客户端操作
	TABLE_STATE_PLAYER_JDZ = 19, --- 叫地主
}
